                ...
                <div class="card">
                  ...
                  <form action="/task/complete/{{$task->id}}" method="post">
                    ...
                    <div class="form-group" style="margin-left: 80px;">
                      ...
                      <textarea class="form-control col-9" style="height:150px;" name="work"></textarea>
                    </div>
                          
                    <div class="form-group " style="margin-left: 80px;">             
                    <button type="submit" class="btn btn-primary" style="background-color: #007bff;">Complete</button>
                    </div>
                  </form>
                  </div>
